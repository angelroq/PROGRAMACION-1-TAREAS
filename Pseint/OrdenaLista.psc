...
Algoritmo OrdenaLista
	...
	Escribir 'Dichos nombres se ordenan por odenn alfabético respentando las mayúsculas'
	// leer la lista
	cant <- 0
	Leer nombre
	Mientras nombre<>'' Hacer
		...
		Repetir
			Leer nombre
			se_repite <- Falso // leer un nombre y ver que no este ya en la lista
	...
	Para i<-1 Hasta cant Hacer
		Escribir '   ', lista[i]
	FinPara
FinAlgoritmo //REVISADO POR: Angel Roquel
